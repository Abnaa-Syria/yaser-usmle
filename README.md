...
- الطالب يشتري **كورس واحد** بمدى الحياة من صفحة الكورس → `/checkout?courseId=...`
- لا يوجد اختيار cohort أو باكدج
- كورسات **HYBRID** تعرض جدول الجلسات المباشرة
- الجلسات الخاصة (1-on-1) تُدفع مباشرة من `/book-private`
...
- **Super Admin:** استخدم حساب المدير الذي أنشأه backend seed
