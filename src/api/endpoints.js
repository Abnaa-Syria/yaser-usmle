const endpoints = {
  ...
  student: {
    ...
    flashcardReview: (id) => `/student/flashcards/${id}/review`,
    flashcardIntervals: "/student/flashcards/intervals",
    myFlashcards: "/student/my-flashcards",
    myFlashcard: (id) => `/student/my-flashcards/${id}`,
    myFlashcardReview: (id) => `/student/my-flashcards/${id}/review`,
