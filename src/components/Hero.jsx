          ...
          >
            <div className="relative mx-auto max-w-[620px] pb-8 pt-3">
              ...
              <div className="group relative aspect-[4/3] overflow-hidden rounded-[1.8rem] border border-white/15 bg-gradient-to-br from-blue-950 to-blue-800 shadow-[0_35px_75px_rgba(0,0,0,.35)]">
                {currentBanner ? (
                  <img src={resolveMediaUrl(currentBanner.imageUrl)} alt={(isRtl ? (currentBanner.titleAr || currentBanner.title) : (currentBanner.title || currentBanner.titleAr)) || t("hero.bannerAlt", { defaultValue: "Yaser USMLE course" })} className="h-full w-full object-cover transition duration-700 group-hover:scale-[1.025]" loading="eager" />
                ) : (
