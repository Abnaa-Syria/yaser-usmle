        ...
        <header className="flex items-center justify-between border-b border-slate-100 dark:border-white/5 p-6 shrink-0">
          <div>
            <h2 className="text-xl font-black text-slate-900 dark:text-white flex items-center gap-2">
              <Layers className="h-5 w-5 text-[var(--yu-blue-700)]" />
        ...
        <div className="px-6 py-4 bg-slate-50 dark:bg-white/[0.02] border-b border-slate-100 dark:border-white/5 flex items-center gap-4 shrink-0">
          {[
            ...
            <div key={item.step} className="flex items-center gap-2 flex-1 last:flex-initial">
              <div className={`flex h-8 w-8 items-center justify-center rounded-full text-xs font-bold transition ${step >= item.step ? "bg-[var(--yu-blue-700)] text-white" : "bg-slate-200 text-slate-500 dark:bg-slate-800"}`}>
            ...
            <div className="space-y-4 max-w-2xl mx-auto">
              <div className="grid gap-4 sm:grid-cols-2">
                <label className="block space-y-1.5">
                  ...
                  <input
                    ...
                    placeholder="e.g. USMLE Step 1 Systems Review Bundle"
                ...
                <label className="block space-y-1.5">
                  ...
                  <input
                    ...
                    className="h-11 w-full rounded-xl border border-slate-200 bg-white px-4 text-sm dark:border-white/10 dark:bg-[#0F0F13] dark:text-white focus:border-[var(--yu-blue-700)] outline-none text-right"
                  />
                </label>
              </div>
              ...
              <label className="block space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white p-4 text-sm dark:border-white/10 dark:bg-[#0F0F13] dark:text-white focus:border-[var(--yu-blue-700)] outline-none"
                />
              </label>
              ...
              <label className="block space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-slate-200 bg-white p-4 text-sm dark:border-white/10 dark:bg-[#0F0F13] dark:text-white focus:border-[var(--yu-blue-700)] outline-none text-right"
                />
              </label>
              ...
              <div className="flex items-center gap-2 pt-2">
                <input
                  ...
                  className="h-4 w-4 accent-[var(--yu-blue-700)]"
                />
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 bg-slate-50 dark:bg-white/[0.02] p-4 rounded-2xl border border-slate-100 dark:border-white/5">
                <div className="flex gap-2">
                  <button
                    ...
                    className={`rounded-xl px-4 py-2 text-xs font-bold transition ${selectionMode === "manual" ? "bg-[var(--yu-blue-700)] text-white" : "border border-slate-200 text-slate-700 dark:border-white/10 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5"}`}
                  >
                  ...
                  <button
                    ...
                    className={`rounded-xl px-4 py-2 text-xs font-bold transition ${selectionMode === "category" ? "bg-[var(--yu-blue-700)] text-white" : "border border-slate-200 text-slate-700 dark:border-white/10 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/5"}`}
                  >
                ...
                <div className="text-xs font-black text-slate-600 dark:text-slate-300 flex items-center gap-1.5">
                  <BookOpen className="h-4 w-4 text-[var(--yu-blue-700)]" />
                ...
                <div className="max-w-md mx-auto space-y-4 py-6">
                  <label className="block space-y-1.5">
                    <span className="text-xs font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1.5">
                      <Folder className="h-4 w-4 text-[var(--yu-blue-700)]" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative max-w-md">
                    ...
                    <input
                      ...
                      className="h-10 w-full rounded-xl border border-slate-200 bg-white pl-10 pr-4 text-xs dark:border-white/10 dark:bg-[#0F0F13] dark:text-white outline-none focus:ring-1 focus:ring-[var(--yu-blue-700)]"
                    />
                  </div>
                    ...
                    {filteredCourses.map((c) => {
                      ...
                      return (
                        <div
                          ...
                          className={`flex items-center gap-3 rounded-2xl border p-4 cursor-pointer transition ${isSelected ? "border-[var(--yu-blue-700)] bg-[var(--yu-blue-700)]/5" : "border-slate-200 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/5"}`}
                        >
                          <input
                            type="checkbox"
                            checked={isSelected}
                    ...
                    <div key={idx} className="flex flex-wrap items-center gap-4 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/40">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          className="h-10 w-28 rounded-xl border border-slate-200 bg-white px-3 text-sm dark:border-white/10 dark:bg-[#0F0F13] dark:text-white focus:border-[var(--yu-blue-700)] outline-none"
                        />
                      </div>
          ...
          <div className="flex gap-2">
            ...
            {step < 3 ? (
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl bg-[var(--yu-blue-700)] text-white px-6 h-10 text-xs font-bold hover:bg-[var(--yu-blue-600)] disabled:opacity-50 transition"
              >
