...
function Topbar({ onMenuClick }) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-slate-200 bg-white dark:border-white/8 dark:bg-[#0F1E38]">
      <div className="flex h-16 min-h-16 items-center justify-between gap-2 px-3 sm:h-20 sm:min-h-20 sm:px-6 md:px-10">
          ...
          <div className="flex min-w-0 items-center gap-2 sm:gap-4 md:gap-6">
            ...
            {isStudentShell ? (
              <Link
                ...
                className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-[var(--yu-blue-200)] bg-[var(--yu-blue-50)] text-[var(--yu-blue-700)] hover:text-[var(--yu-blue-700)] md:hidden"
              >
            ...
            <div className="hidden min-w-0 items-center gap-4 md:flex lg:gap-6">
              {isStudentShell ? (
                <>
                  <Link
                    to="/"
                    className="inline-flex items-center gap-2 rounded-xl border border-[var(--yu-blue-200)] bg-[var(--yu-blue-50)] px-3 py-1.5 text-xs font-semibold text-[var(--yu-blue-700)] transition hover:bg-[var(--yu-blue-700)] hover:text-white dark:border-[var(--yu-blue-700)]/30 dark:bg-[var(--yu-blue-700)]/10 dark:text-[var(--yu-blue-300)] dark:hover:bg-[var(--yu-blue-700)] dark:hover:text-white"
                  >
        ...
        <div className="flex shrink-0 items-center gap-1 sm:gap-2 md:gap-4 lg:gap-6">
          ...
          <div className="relative">
            ...
            {isProfileOpen && (
              <div className="absolute end-0 z-50 mt-3 w-[min(14rem,calc(100vw-1.5rem))] rounded-2xl border border-slate-100 bg-white p-2 shadow-lg sm:mt-4 sm:w-56 dark:border-white/8 dark:bg-[#0F1E38] dark:shadow-2xl dark:shadow-black/50">
