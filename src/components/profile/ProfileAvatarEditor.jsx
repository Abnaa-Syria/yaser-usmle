      ...
      <div className="flex flex-wrap gap-2">
        ...
        {avatar ? (
          <button
            ...
            disabled={updateAvatar.isPending}
            className="inline-flex items-center gap-2 rounded-xl border border-red-200/80 px-3 py-2 text-xs font-semibold text-red-600 hover:bg-[var(--yu-blue-700)]/10 dark:border-red-500/30 dark:text-red-400 dark:hover:bg-[var(--yu-blue-700)]/10"
          >
