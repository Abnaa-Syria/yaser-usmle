...
export default function EventCard({ event }) {
  ...
  return (
    ...
    >
      {/* Accent color strip */}
      <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-orange-400 to-[var(--yu-blue-700)] opacity-80" />
      ...
      <div className="relative h-44 w-full overflow-hidden bg-slate-100 dark:bg-slate-900">
        {event.bannerUrl ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-slate-850 to-slate-950 p-6 text-[var(--yu-blue-700)]/15">
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="flex flex-wrap items-center gap-3 text-xs text-slate-500 dark:text-slate-450 mb-3">
          <span className="flex items-center gap-1">
            <Calendar className="h-3.5 w-3.5 text-[var(--yu-blue-700)]" />
        ...
        {/* Title */}
        <h3 className="text-base font-extrabold text-slate-900 group-hover:text-[var(--yu-blue-700)] transition duration-150 line-clamp-2 dark:text-white leading-snug">
        ...
        {isUpcoming && timeLeft > 0 && (
          <div className="mt-4 rounded-2xl bg-orange-50/50 border border-orange-100 p-3 dark:bg-orange-950/10 dark:border-orange-900/10">
            <div className="flex justify-between items-center text-[10px] text-slate-450 dark:text-slate-500 font-bold uppercase tracking-wide">
              ...
              <span className="font-mono text-xs font-bold text-[var(--yu-blue-700)]">{formatTimeLeft(timeLeft, isRtl)}</span>
            </div>
          </div>
        )}
        ...
        <div className="mt-5 border-t border-slate-100 pt-4 dark:border-slate-800">
          {isOnline ? (
            <a
              ...
              className="flex w-full items-center justify-center gap-1.5 rounded-2xl bg-[var(--yu-blue-700)] hover:bg-orange-600 py-3 text-xs font-bold text-white transition shadow-sm active:scale-[0.98]"
            >
            ...
            <div className="flex items-center justify-between text-xs">
              <span className="flex items-center gap-1.5 text-slate-650 dark:text-slate-350 font-bold">
                <MapPin className="h-4 w-4 text-[var(--yu-blue-700)]" />
