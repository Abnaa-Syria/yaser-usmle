  ...
  return (
    <div className="mt-8 rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
      <h3 className="flex items-center gap-2 text-sm font-bold text-slate-900">
        <MessageSquare className="h-4 w-4 text-yu-blue-700" />
      ...
      <div className="mt-4 flex flex-col gap-2 sm:flex-row">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-yu-blue-700 px-4 py-2.5 text-sm font-bold text-white hover:bg-yu-blue-600 disabled:opacity-50"
        >
