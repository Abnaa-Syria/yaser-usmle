...
export function formatSessionPrice(price) {
      ...
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl">
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            ...
            {slot.price > 0 ? (
              <p className="mt-2 text-lg font-extrabold text-yu-blue-700">{formatSessionPrice(slot.price, isRtl)}</p>
            ) : null}
          </div>
        ...
        <form onSubmit={(e) => void onSubmit(e)} className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="inline-flex items-center gap-2 rounded-lg bg-yu-blue-700 px-4 py-2 text-sm font-bold text-white hover:bg-yu-blue-600 disabled:opacity-50"
            >
