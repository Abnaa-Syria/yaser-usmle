  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 p-4" role="dialog" aria-modal="true">
      <div className="relative max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl">
        ...
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-yu-blue-100">
          <Sparkles className="h-6 w-6 text-yu-blue-500-dark" />
        </div>
        ...
        <div className="mt-6 flex flex-col gap-2 sm:flex-row">
          ...
          <Link
            to="/explore"
            className="inline-flex flex-1 items-center justify-center rounded-xl bg-yu-blue-700 px-4 py-2.5 text-sm font-bold text-white hover:bg-yu-blue-600"
          >
            {t("quotaModal.cta")}
          </Link>
        </div>
