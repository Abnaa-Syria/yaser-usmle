      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl dark:bg-slate-900">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button
            ...
            onClick={requestOtp}
            disabled={requesting}
            className="rounded-lg border border-yu-blue-500 px-4 py-2 text-sm font-medium text-yu-blue-500 hover:bg-yu-blue-500/10"
          >
          ...
          <div className="ms-auto flex gap-2">
            ...
            <button
              ...
              disabled={loading}
              className="rounded-lg bg-yu-blue-700 px-4 py-2 text-sm font-semibold text-white hover:bg-yu-blue-600"
            >
