...
export default function Instructors() {
  ...
  return (
    <div className="bg-white">
      <section className="border-b border-slate-100 bg-gradient-to-b from-yu-blue-100/40 to-white py-14 md:py-16">
        <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
          ...
          <form onSubmit={onSearch} className="mx-auto mt-8 flex max-w-xl gap-2">
            ...
            <button type="submit" className="shrink-0 rounded-xl bg-yu-blue-700 px-5 text-sm font-bold text-white hover:bg-yu-blue-600">
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
          ...
          {isError ? (
            <div className="rounded-2xl border border-red-100 bg-red-50 px-4 py-8 text-center text-sm text-red-700">
              ...
              <button type="button" onClick={() => void refetch()} className="font-semibold text-yu-blue-700 hover:underline">
                {t("takeExam.retry")}
              </button>
            </div>
          ) : null}
          ...
          {!isLoading && !isError && instructors.length === 0 ? (
            <div className="flex flex-col items-center gap-3 py-16 text-center">
              ...
              <Link to="/explore" className="text-sm font-semibold text-yu-blue-700 hover:underline">
