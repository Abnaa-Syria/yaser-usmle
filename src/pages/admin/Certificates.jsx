                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap items-center gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-lg bg-[var(--yu-blue-700)] px-2.5 py-1.5 text-xs font-bold text-white hover:bg-[var(--yu-blue-600)] disabled:opacity-60"
                        >
      ...
      <div className="w-full max-w-2xl rounded-xl border border-slate-200 bg-white shadow-xl dark:border-white/10 dark:bg-[#1A1A22]">
        <form onSubmit={submit} className="space-y-4 p-5">
          ...
          <div className="flex justify-end gap-2">
            ...
            <button disabled={issueMutation.isPending} type="submit" className="rounded-lg bg-[var(--yu-blue-700)] px-3 py-2 text-sm font-bold text-white disabled:opacity-70">
