...
const area =
  "min-h-28 w-full rounded-xl border border-slate-200 bg-white p-4 text-sm leading-relaxed text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-[var(--yu-blue-700)] focus:ring-2 focus:ring-[var(--yu-blue-700)]/20 dark:border-white/10 dark:bg-[#0F0F13] dark:text-slate-200";
    ...
    <div className="flex flex-wrap gap-2">
      {links.map(({ to, label, icon: Icon, admin }) => (
        <Link
          ...
          className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:border-[var(--yu-blue-700)]/40 hover:bg-[var(--yu-blue-700)]/10 hover:text-[var(--yu-blue-600)] dark:border-white/10 dark:bg-white/5 dark:text-slate-200"
        >
      ...
      {["en", "ar"].map((lang) => (
        <button
          ...
          className={`rounded-lg px-3 py-1.5 text-xs font-bold transition ${
            contentLang === lang ? "bg-[var(--yu-blue-700)] text-white" : "bg-slate-100 text-slate-600 dark:bg-white/10"
          }`}
        >
          ...
          {TABS.map(({ id, icon: Icon, labelKey, defaultLabel }) => (
            <button
              ...
              className={`inline-flex items-center gap-2 rounded-t-lg px-4 py-2.5 text-sm font-semibold transition ${
                tab === id
                  ? "border-b-2 border-[var(--yu-blue-700)] text-[var(--yu-blue-700)]"
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            <div className={card}>
              ...
              <button
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-xl bg-[var(--yu-blue-700)] px-6 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-[var(--yu-blue-600)] disabled:opacity-50"
              >
        ...
        {tab === "about" ? (
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <div className={card}>
              ...
              <div className="space-y-4">
                <div className="rounded-xl border border-yu-blue-100 bg-yu-blue-100/30 p-4 dark:border-yu-blue-700/20">
                  <p className="text-xs font-bold uppercase text-yu-blue-700">{t("publicAbout.mission", { defaultValue: "Mission" })}</p>
          ...
          <div className={card}>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-lg border border-[var(--yu-blue-700)] px-4 py-2 text-xs font-bold text-[var(--yu-blue-700)] transition hover:bg-[var(--yu-blue-700)] hover:text-white"
                      >
            ...
            <div className="mt-8 rounded-xl border border-dashed border-slate-200 p-5 dark:border-white/10">
              ...
              <button
                ...
                className="mt-4 inline-flex items-center gap-2 rounded-xl bg-[var(--yu-blue-700)] px-5 py-2.5 text-sm font-bold text-white transition hover:bg-[var(--yu-blue-600)] disabled:opacity-50"
              >
