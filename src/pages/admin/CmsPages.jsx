            ...
            <li key={row.id} className="rounded-xl border border-slate-100 bg-slate-50/80 p-4 dark:border-white/5 dark:bg-white/[0.03]">
              <div className="flex flex-wrap items-start justify-between gap-2">
                <div>
                  ...
                  <a href={`mailto:${row.email}`} className="text-sm text-[var(--yu-blue-700)]">
                    {row.email}
                  </a>
                </div>
                <span
              ...
              {row.status === "NEW" ? (
                <button
                  ...
                  className="mt-3 text-xs font-bold text-[var(--yu-blue-700)] hover:underline"
                >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        {meta?.route ? (
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-2 rounded-full border border-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-700 transition hover:border-[var(--yu-blue-700)]/40 hover:text-[var(--yu-blue-700)] dark:border-white/10 dark:text-slate-200"
          >
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-[var(--yu-blue-700)] px-3 py-1.5 text-xs font-bold text-[var(--yu-blue-700)] transition hover:bg-[var(--yu-blue-700)] hover:text-white"
          >
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 border-t border-slate-200 pt-5 dark:border-white/10">
        <label className="inline-flex items-center gap-2 text-sm font-semibold text-slate-700 dark:text-slate-200">
          <input
            ...
            className="rounded border-slate-300 text-[var(--yu-blue-700)] focus:ring-[var(--yu-blue-700)]"
          />
        ...
        <button
          ...
          onClick={save}
          className="inline-flex items-center gap-2 rounded-xl bg-[var(--yu-blue-700)] px-6 py-2.5 text-sm font-bold text-white transition hover:bg-[var(--yu-blue-600)] disabled:opacity-50"
        >
