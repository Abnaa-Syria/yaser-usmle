...
export default function ExamEditor() {
  ...
  if (isError || !exam) return (
    <div className="mx-auto max-w-lg space-y-4 py-20 text-center">
      ...
      <Link to="/admin/exams" className="text-sm text-[var(--yu-blue-700)] hover:underline">{label("backToExams", "← Back to exams")}</Link>
    </div>
  );
        ...
        <div className="flex items-center justify-between">
          ...
          {!editingSettings ? (
            ...
            <div className="flex gap-2">
              ...
              <button onClick={saveSettings} disabled={updateExamMutation.isPending} className="inline-flex items-center gap-1 rounded-lg bg-[var(--yu-blue-700)] px-3 py-1.5 text-xs font-bold text-white hover:bg-[var(--yu-blue-600)] disabled:opacity-50">
