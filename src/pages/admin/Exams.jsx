    ...
    <section className="space-y-6">
      <PageHeader
        ...
        action={
          <Link
            to="/admin/exams/new"
            className="inline-flex items-center gap-2 rounded-lg bg-[var(--yu-blue-700)] px-4 py-2 text-sm font-bold text-white"
          >
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/8 dark:bg-[#1A1A22]">
          <div className="mb-2 inline-flex rounded-lg bg-[var(--yu-blue-700)]/10 p-2 text-[var(--yu-blue-700)]">
      ...
      <div className="relative max-w-md">
        ...
        <input
          ...
          className="h-11 w-full rounded-xl border border-slate-200 bg-white ps-9 pe-3 text-sm text-slate-900 outline-none focus:border-[var(--yu-blue-700)] dark:border-white/10 dark:bg-[#0F0F13] dark:text-white"
        />
      </div>
              ...
              render: (_, row) => (
                <div className="flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="rounded p-1.5 text-red-500 hover:bg-[var(--yu-blue-700)]/10"
                  >
