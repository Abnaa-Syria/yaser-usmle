import { 
  ...
  Percent, Loader2, Pencil, X, Plus, Trash2
} from "lucide-react";
...
import {
  ...
  useCreateAdminInstructorAvailability,
  useDeleteAdminInstructorAvailability,
  useUpdateInstructor,
...
const COLORS = ["var(--yu-blue-700)", "#14B8A6", "#8B5CF6", "#EF4444", "#3B82F6"];
...
function InstructorDetail() {
  ...
  const createAvailability = useCreateAdminInstructorAvailability(id);
  const deleteAvailability = useDeleteAdminInstructorAvailability(id);
  const [slotForm, setSlotForm] = useState({ date: "", start: "10:00", end: "11:00", price: "75" });
  ...
  const instructor = useMemo(() => {
    ...
    const currency = entity.wallet?.currency || "USD";
    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="flex flex-col items-center gap-3">
          <div className="h-10 w-10 animate-spin rounded-full border-4 border-[var(--yu-blue-700)] border-t-transparent"></div>
    ...
    return (
      <div className="mx-auto max-w-lg py-20 text-center">
        ...
        <div className="mt-6 flex justify-center gap-3">
          <button onClick={() => refetch()} className="rounded-xl bg-[var(--yu-blue-700)] px-5 py-2.5 text-sm font-bold text-white transition hover:bg-[var(--yu-blue-600)]">
  ...
  return (
    <section className="space-y-6 antialiased">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-white/8 dark:bg-[#1A1A22]">
        <div className="absolute right-0 top-0 -mr-6 -mt-6 h-24 w-24 rounded-full bg-gradient-to-tr from-[var(--yu-blue-700)]/10 to-[var(--yu-blue-700)]/20 blur-xl"></div>
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[var(--yu-blue-700)] px-4 py-2.5 text-sm font-bold text-white shadow-sm shadow-[var(--yu-blue-700)]/20 transition hover:bg-[var(--yu-blue-600)]"
            >
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 rounded-xl px-4 py-2.5 text-xs font-bold transition-all sm:text-sm ${
                    isSelected
                      ? "bg-[var(--yu-blue-700)] text-white shadow-sm shadow-[var(--yu-blue-700)]/20"
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-6 lg:grid-cols-5">
                  ...
                  <div className="space-y-4">
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          className="h-10 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm font-medium text-slate-900 outline-none focus:border-[var(--yu-blue-700)] dark:border-white/10 dark:bg-[#0F0F13] dark:text-white"
                        />
                      </div>
                      <div className="space-y-1.5">
                        <label className="text-xs font-semibold text-slate-400">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        rows={4}
                        className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-900 outline-none focus:border-[var(--yu-blue-700)] dark:border-white/10 dark:bg-[#0F0F13] dark:text-white"
                      />
                    </div>
                    <label className="flex cursor-pointer items-center gap-2 text-sm font-semibold text-slate-700 dark:text-slate-200">
                      <input
                        ...
                        className="h-4 w-4 rounded border-slate-300 accent-[var(--yu-blue-700)]"
                      />
                    ...
                    <div className="flex flex-wrap justify-end gap-2 border-t border-slate-100 pt-4 dark:border-white/5">
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 rounded-lg bg-[var(--yu-blue-700)] px-4 py-2 text-xs font-bold text-white transition hover:bg-[var(--yu-blue-600)] disabled:opacity-60"
                      >
                  ...
                  <div className="h-64" dir="ltr">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={enrollBars}>
                        ...
                        <Bar dataKey="enrollments" fill="var(--yu-blue-700)" radius={[6, 6, 0, 0]} barSize={32} />
                      </BarChart>
                    </ResponsiveContainer>
                  </div>
                )}
            ...
            <div className="space-y-6 lg:col-span-2">
              ...
              <div className="space-y-2 rounded-2xl border border-[var(--yu-blue-700)]/10 bg-slate-50/50 p-5 dark:border-white/5 dark:bg-white/5">
                ...
                <PermissionGate permission="support:manage">
                  <button
                    ...
                    className="flex w-full items-center gap-2.5 rounded-xl border border-slate-200/80 bg-white px-4 py-3 text-sm font-bold text-slate-800 transition hover:border-[var(--yu-blue-700)]/40 hover:bg-[var(--yu-blue-700)]/5 dark:border-white/10 dark:bg-[#0F0F13] dark:text-slate-200"
                  >
                    <MessageSquare className="h-4.5 w-4.5 text-[var(--yu-blue-700)]" />
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              ...
              {commissionDirty && canManageCommission ? (
                <button
                  ...
                  className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-[var(--yu-blue-700)] px-4 py-2.5 text-xs font-bold text-white transition hover:bg-[var(--yu-blue-600)] disabled:opacity-60"
                >
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  <input
                    ...
                    className="h-2 flex-1 cursor-pointer appearance-none rounded-full bg-slate-200 accent-[var(--yu-blue-700)] disabled:cursor-not-allowed disabled:opacity-60 dark:bg-white/10"
                  />
              ...
              <div className="h-56" dir="ltr">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={earningsTrend}>
                    ...
                    <Tooltip />
                    <Area type="monotone" dataKey="amount" stroke="var(--yu-blue-700)" fill="url(#colorEarning)" strokeWidth={2.5} />
                    <defs>
                      <linearGradient id="colorEarning" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor="var(--yu-blue-700)" stopOpacity={0.2}/>
              ...
              <div className="mb-4 flex items-center justify-between gap-3">
                ...
                {payRows.length > 0 ? (
                  <Link
                    ...
                    className="text-xs font-bold text-[var(--yu-blue-700)] hover:underline"
                  >
      ...
      {activeTab === "availability" ? (
        <div className="space-y-4">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-white/8 dark:bg-[#1A1A22]">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">
              {t("adminPages.instructorDetail.availability.subtitleManage", {
                defaultValue: "Publish bookable 1-on-1 session slots students can reserve from the course page.",
              })}
            </p>

            {platformFeatures.privateBooking && canManageInstructor ? (
              <form
                className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-5"
                onSubmit={async (e) => {
                  e.preventDefault();
                  if (!slotForm.date || !slotForm.start || !slotForm.end) {
                    toast.error(t("adminPages.instructorDetail.availability.invalidRange", { defaultValue: "Pick a date and time range." }));
                    return;
                  }
                  const startTime = new Date(`${slotForm.date}T${slotForm.start}:00`);
                  const endTime = new Date(`${slotForm.date}T${slotForm.end}:00`);
                  if (!(endTime > startTime)) {
                    toast.error(t("adminPages.instructorDetail.availability.invalidRange", { defaultValue: "End time must be after start time." }));
                    return;
                  }
                  const price = Number(slotForm.price);
                  if (!Number.isFinite(price) || price <= 0) {
                    toast.error(t("adminPages.instructorDetail.availability.priceRequired", { defaultValue: "Enter a valid session price." }));
                    return;
                  }
                  try {
                    ...
                    toast.success(t("adminPages.instructorDetail.availability.added", { defaultValue: "Slot published." }));
                  } catch (err) {
                    toast.error(getErrorMessage(err, t("adminPages.instructorDetail.availability.addFailed", { defaultValue: "Failed to add slot." })));
                  }
                }}
              >
                <label className="space-y-1 text-xs font-bold text-slate-500">
                  {t("adminPages.instructorDetail.availability.labelDate", { defaultValue: "Date" })}
                  <input
                    type="date"
                    value={slotForm.date}
                ...
                <label className="space-y-1 text-xs font-bold text-slate-500">
                  {t("adminPages.instructorDetail.availability.labelStart", { defaultValue: "Start" })}
                  <input
                    type="time"
                ...
                <label className="space-y-1 text-xs font-bold text-slate-500">
                  {t("adminPages.instructorDetail.availability.labelEnd", { defaultValue: "End" })}
                  <input
                    type="time"
                    value={slotForm.end}
                ...
                <label className="space-y-1 text-xs font-bold text-slate-500">
                  {t("adminPages.instructorDetail.availability.labelPrice", { defaultValue: "Price (USD)" })}
                  <input
                    type="number"
                    min="1"
                    step="1"
                    value={slotForm.price}
                    onChange={(e) => setSlotForm((s) => ({ ...s, price: e.target.value }))}
                    className="h-10 w-full rounded-lg border border-slate-200 px-3 text-sm dark:border-white/10 dark:bg-[#0F0F13] dark:text-white"
                    required
                  />
                </label>
                <div className="flex items-end">
                  <button
                    ...
                    className="inline-flex h-10 w-full items-center justify-center gap-2 rounded-lg bg-[var(--yu-blue-700)] px-4 text-sm font-bold text-white disabled:opacity-60"
                  >
                    {createAvailability.isPending ? <Loader2 className="h-4 w-4 animate-spin" /> : <Plus className="h-4 w-4" />}
                    {t("adminPages.instructorDetail.availability.addCta", { defaultValue: "Add slot" })}
                  </button>
                </div>
              </form>
            ) : null}
          ...
          {availabilityQuery.isLoading ? (
            ...
            <div className="rounded-2xl border border-red-200 bg-[var(--yu-blue-700)]/10 p-5 text-sm text-red-700 dark:border-red-500/30">
              {t("adminPages.instructorDetail.availability.loadError", { defaultValue: "Failed to load instructor slots." })}
              <button onClick={() => availabilityQuery.refetch()} className="ms-3 rounded-lg bg-[var(--yu-blue-700)] px-3 py-1 text-xs font-bold text-white">
              ...
              {(availabilityQuery.data || []).map((slot) => (
                <div key={slot.id} className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-white/8 dark:bg-[#1A1A22]">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {slot.price != null ? (
                      <p className="mt-1 text-xs font-bold text-[var(--yu-blue-700)]">{Math.round(Number(slot.price))} USD</p>
                    ) : null}
                  </div>
                  {canManageInstructor ? (
                    <button
                      ...
                      onClick={async () => {
                        try {
                          await deleteAvailability.mutateAsync(slot.id);
                          toast.success(t("adminPages.instructorDetail.availability.removed", { defaultValue: "Slot removed." }));
                        } catch (err) {
                          toast.error(getErrorMessage(err, t("adminPages.instructorDetail.availability.removeFailed", { defaultValue: "Failed to remove slot." })));
                        }
                      }}
                    >
