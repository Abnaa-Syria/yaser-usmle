...
function PackageCard({
  ...
  return (
    ...
    >
      <div className="absolute inset-x-0 top-0 h-1.5 bg-gradient-to-r from-[var(--yu-blue-700)] via-amber-400 to-[#3B82F6]" />
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1.5 text-xs text-[var(--yu-blue-700)] font-bold flex items-center gap-1">
        ...
        <div className="space-y-1.5 mt-1">
          {(pkg.pricingTiers || []).map((tier: any) => (
            <div key={tier.id} className="flex items-center justify-between text-xs border-b border-slate-100 dark:border-white/5 pb-1 last:border-0 last:pb-0">
              ...
              <span className="font-extrabold text-[var(--yu-blue-700)]">${tier.price}</span>
            </div>
          ))}
      ...
      <div className="mt-5 flex items-center justify-end gap-2 border-t border-slate-100 pt-4 dark:border-white/10">
        ...
        <button
          type="button"
          onClick={onDelete}
          className="inline-flex h-9 items-center gap-1.5 rounded-xl bg-[var(--yu-blue-700)]/10 px-3 text-xs font-bold text-red-600 transition hover:bg-red-150 dark:bg-[var(--yu-blue-700)]/10 dark:text-red-300 dark:hover:bg-[var(--yu-blue-700)]/20"
        >
...
function EmptyState({
  ...
  return (
    <div className="rounded-3xl border-2 border-dashed border-slate-200 py-16 text-center dark:border-white/10">
      ...
      <button
        onClick={onCreate}
        className="mt-6 inline-flex items-center gap-1.5 rounded-xl bg-[var(--yu-blue-700)] px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-[var(--yu-blue-700)]/25 hover:bg-[var(--yu-blue-600)] transition"
      >
        {action}
      </button>
    </div>
