...
export default function ReviewQueue() {
  ...
  return (
    <section>
      ...
      {isError ? (
        <div className="rounded-xl border border-red-100 bg-yu-blue-100 p-4 text-sm text-red-800">
        ...
        columns={[
          {
            ...
            render: (v, row) => (
              <Link to={`/admin/courses/${row.id}/edit`} className="font-semibold text-yu-blue-700 hover:underline">
                {v}
              </Link>
            ),
          },
