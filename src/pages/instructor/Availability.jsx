                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 ps-2">
                          ...
                          {slot.status === "AVAILABLE" && (
                            <button
                              ...
                              className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 text-slate-400 transition hover:border-red-300/80 hover:bg-[var(--yu-blue-700)]/10 hover:text-red-500 dark:border-white/10 dark:text-slate-500 dark:hover:border-red-500/40 dark:hover:text-red-400"
                            >
