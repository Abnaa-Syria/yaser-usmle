  ...
  const inputClass = (hasError) => 
    `h-12 w-full rounded-xl border px-4 text-xs font-semibold outline-none transition-all ${
      hasError 
        ...
        : "border-slate-200 bg-white focus:border-[var(--yu-blue-700)] dark:border-white/10 dark:bg-[#0F172A] dark:text-white"
    }`;
    ...
    <div className="max-w-2xl mx-auto space-y-8 antialiased font-sans pb-20 pt-4">
      ...
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-white font-cairo">
          {dir === "rtl" ? "إضافة كورس جديد" : "Create New Step 1 Course"}
        </h1>
          ...
          <div key={s.number} className="flex items-center flex-1 last:flex-initial">
            <div className="flex items-center gap-3">
              <div className={`h-8 w-8 rounded-lg flex items-center justify-center font-bold text-xs transition-all ${
                step >= s.number 
                  ? "bg-[var(--yu-blue-700)] text-white shadow-md shadow-[var(--yu-blue-700)]/15" 
            ...
            {idx < 2 && (
              <div className={`h-[2px] mx-4 flex-1 transition-all ${
                step > s.number ? "bg-[var(--yu-blue-700)]" : "bg-slate-200 dark:bg-white/5"
              }`} />
            )}
          </div>
        ))}
        ...
        <div className="space-y-5 rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#1E293B]">
          ...
          <label className="block">
            ...
            <textarea
              ...
              rows={4}
              className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-xs font-semibold text-slate-900 outline-none transition-all focus:border-[var(--yu-blue-700)] dark:border-white/10 dark:bg-[#0F172A] dark:text-white"
            />
          </label>
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 mt-1">
                <button
                  type="button"
                  disabled
                  className="flex flex-col items-center justify-center p-4 rounded-xl border border-[var(--yu-blue-700)] bg-[var(--yu-blue-700)]/5 text-[var(--yu-blue-700)] col-span-2 sm:col-span-1"
                >
          ...
          <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-[#1E293B] space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 text-xs">
              ...
              <div>
                ...
                <span className="font-bold text-[var(--yu-blue-700)]">
                  {dir === "rtl" ? "مسجل" : "RECORDED"}
                </span>
              </div>
              <div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-blue-700 dark:text-blue-300 leading-relaxed">
                {dir === "rtl" 
                  ...
                  : "After creating the course, you will be taken to the Curriculum Console to construct units, sections, lessons, and quiz assessment parameters."}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between border-t border-slate-200 dark:border-white/5 pt-6">
        ...
        {step < 3 ? (
          <button
            type="button"
            onClick={handleNext}
            className="flex items-center justify-center gap-2 rounded-xl bg-[var(--yu-blue-700)] hover:bg-[var(--yu-blue-600)] text-white px-6 py-2.5 text-xs font-bold shadow-lg shadow-[var(--yu-blue-700)]/15 transition-all"
          >
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-[var(--yu-blue-700)] hover:bg-[var(--yu-blue-600)] text-white px-6 py-2.5 text-xs font-bold shadow-lg shadow-[var(--yu-blue-700)]/15"
            >
