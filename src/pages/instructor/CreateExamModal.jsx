  ...
  return (
    <button
      ...
      className={`flex flex-1 items-center justify-center gap-2 rounded-xl border px-3 py-2.5 text-xs font-bold transition-all ${
        active
          ? "border-[var(--yu-blue-700)]/50 bg-[var(--yu-blue-700)]/10 text-[var(--yu-blue-700)] dark:bg-[var(--yu-blue-700)]/15"
      ...
      >
              ...
              <section className="space-y-4 rounded-xl border border-slate-200 bg-slate-50/60 p-4 dark:border-white/10 dark:bg-[#12121a]/40">
                ...
                <label className="block space-y-1.5">
                  <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
                    {t("dashboard.instructor.exams.create.titleLabel")} <span className="text-[var(--yu-blue-700)]">*</span>
                  </span>
                  <input
                    value={title}
                ...
                <label className="block space-y-1.5">
                  <span className="text-sm font-semibold text-slate-700 dark:text-slate-200">
                    {t("dashboard.instructor.exams.create.courseLabel")} <span className="text-[var(--yu-blue-700)]">*</span>
                  </span>
                ...
                <section className="space-y-4 rounded-xl border border-slate-200 bg-slate-50/60 p-4 dark:border-white/10 dark:bg-[#12121a]/40">
                  ...
                  {scopeSummary ? (
                    <p className="rounded-lg bg-white px-3 py-2 text-xs font-medium text-slate-600 dark:bg-[#12121a] dark:text-slate-300">
                      <span className="font-bold text-[var(--yu-blue-700)]">{t("dashboard.instructor.exams.scope")}: </span>
                      {scopeSummary}
                    </p>
                  ) : null}
                </section>
        ...
        <div className="flex items-center justify-end gap-2 border-t border-slate-200 px-6 py-4 dark:border-white/10">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-[var(--yu-blue-700)] px-5 py-2.5 text-sm font-bold text-white disabled:opacity-60"
          >
