  ...
  if (examError || !exam) {
    return (
      <section className="space-y-3">
        ...
        <Link to="/instructor/exams" className="inline-flex items-center gap-1 text-sm font-semibold text-[var(--yu-blue-700)] hover:underline">
  ...
  return (
    <section className="space-y-6 pb-12">
      ...
      <div className="space-y-4">
        <Link
          to="/instructor/exams"
          className="inline-flex items-center gap-1.5 text-sm font-semibold text-[var(--yu-blue-700)] hover:underline"
        >
