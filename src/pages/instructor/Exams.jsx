...
const SEARCH_INPUT =
  "h-10 w-full rounded-xl border border-slate-200 bg-white ps-10 pe-3 text-sm text-slate-900 outline-none focus:border-[var(--yu-blue-700)] dark:border-white/15 dark:bg-[#12121a] dark:text-slate-100 sm:w-64";
    ...
    <section className="space-y-6 pb-10">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-2 self-start rounded-xl bg-[var(--yu-blue-700)] px-5 py-2.5 text-sm font-bold text-white hover:bg-[var(--yu-blue-600)]"
        >
        ...
        columns={[
          {
            ...
            render: (v, row) => (
              <div className="flex items-center gap-3">
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[var(--yu-blue-700)]/10 text-[var(--yu-blue-700)]">
            ...
            render: (_, row) => (
              <div className="flex flex-wrap items-center gap-1.5">
                <Link
                  ...
                  className="inline-flex items-center gap-1 rounded-lg bg-[var(--yu-blue-700)]/10 px-3 py-1.5 text-xs font-bold text-[var(--yu-blue-700)] hover:bg-[var(--yu-blue-700)]/20"
                >
