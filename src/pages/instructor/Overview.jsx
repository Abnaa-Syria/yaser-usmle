...
/* ─── colour palette ─── */
const BRAND_ORANGE = "var(--yu-blue-700)";
const BAR_COLORS = ["var(--yu-blue-700)", "#3B82F6", "#10B981", "#F59E0B", "#8B5CF6"];
  ...
  return (
    <section className="space-y-8">
        ...
        {isLoading ? (
          ...
          <>
            <MetricCard
              ...
              value={`USD ${Number(summary?.walletBalance ?? 0).toLocaleString()}`}
              icon={Wallet}
            ...
            <MetricCard
              ...
              value={`USD ${Number(summary?.totalEarnings ?? 0).toLocaleString()}`}
              icon={DollarSign}
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="overflow-hidden rounded-2xl border border-slate-200/60 bg-white shadow-sm dark:border-slate-700/40 dark:bg-[#1E293B] lg:col-span-2">
          <div className="flex items-center justify-between border-b border-slate-100 px-6 py-5 dark:border-slate-700/30">
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[var(--yu-blue-700)] to-orange-600 shadow-lg shadow-orange-500/20">
              ...
              <div className="h-[300px] w-full" dir="ltr">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={earningsTrend}>
                    ...
                    />
                    <Tooltip content={(props) => <ChartTooltip {...props} valuePrefix="USD " />} />
                    <Area
                      type="monotone"
                      dataKey="total"
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        {/* ── left: activity feed ── */}
        <div className="overflow-hidden rounded-2xl border border-slate-200/60 bg-white shadow-sm dark:border-slate-700/40 dark:bg-[#1E293B] lg:col-span-5">
                  ...
                  >
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-sm font-semibold text-slate-900 dark:text-white">
                          <span className="text-[var(--yu-blue-700)]">{item.studentName}</span>
                    ...
                    {item.amount != null && (
                      <p className="text-sm font-extrabold tabular-nums text-emerald-500" dir="ltr">
                        +USD {Number(item.amount).toLocaleString()}
                      </p>
                    )}
                  </div>
                );
