      ...
      <PageHeader
        ...
        actions={
          <select
            ...
            className="h-10 rounded-xl border border-slate-200 bg-white px-3 text-sm dark:border-white/10 dark:bg-[#1A1A22] dark:text-white outline-none focus:border-[var(--yu-blue-700)] transition-all"
          >
        ...
        <div className="lg:col-span-5 flex flex-col h-full bg-white dark:bg-[#1A1A22] rounded-2xl border border-slate-200 dark:border-white/10 overflow-hidden shadow-xs">
          <div className="p-4 border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-[#1C1C26]">
            <h3 className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider flex items-center gap-2">
              ...
              <span className="ms-auto bg-[var(--yu-blue-700)]/10 text-[var(--yu-blue-700)] text-[10px] font-extrabold px-2 py-0.5 rounded-full">
                {questions.length}
              </span>
            </h3>
          </div>
                ...
                return (
                  <button
                    ...
                    className={`w-full text-start p-4 transition-all flex flex-col gap-1.5 focus:outline-none ${
                      isSelected 
                        ? "bg-[var(--yu-blue-700)]/5 dark:bg-[var(--yu-blue-700)]/10 border-s-4 border-s-[var(--yu-blue-700)]" 
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="p-4 border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-[#1C1C26] flex items-center justify-between gap-4">
                <div className="min-w-0">
                  <span className="text-[9px] font-extrabold text-[var(--yu-blue-700)] uppercase tracking-wider block">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-[10px] font-bold transition-all shrink-0 ${
                    activeQuestion.isResolved
                      ...
                      : "bg-[var(--yu-blue-700)]/10 text-[var(--yu-blue-700)] border border-[var(--yu-blue-700)]/20 hover:bg-[var(--yu-blue-700)]/20"
                  }`}
                >
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div className="flex gap-3">
                  {/* Student Avatar */}
                  <div className="h-8 w-8 rounded-full bg-gradient-to-tr from-[var(--yu-blue-700)] to-amber-400 flex items-center justify-center text-white text-[11px] font-bold shrink-0 shadow-sm uppercase">
                  ...
                  return (
                    <div key={a.id} className={`flex gap-3 ${isInstructor ? "flex-row-reverse" : ""}`}>
                      ...
                      <div className={`flex flex-col max-w-[85%] p-3.5 rounded-2xl ${
                        isInstructor 
                          ? "bg-[var(--yu-blue-700)]/10 border border-[var(--yu-blue-700)]/20 rounded-se-none" 
                        ...
                        <div className="flex items-center justify-between gap-4 mb-1">
                          <span className="text-[10px] font-extrabold text-slate-700 dark:text-slate-300">
                            ...
                            {isInstructor && (
                              <span className="ms-1.5 text-[8px] font-extrabold px-1.5 py-0.5 rounded bg-[var(--yu-blue-700)] text-white">
              ...
              <form onSubmit={onReplySubmit} className="p-4 border-t border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-[#1C1C26] flex gap-2 items-end">
                ...
                <button
                  ...
                  className="h-10 px-4 rounded-xl bg-[var(--yu-blue-700)] hover:bg-[var(--yu-blue-600)] text-white text-xs font-bold shadow-md shadow-[var(--yu-blue-700)]/15 transition-all flex items-center gap-1.5 shrink-0 disabled:opacity-50 disabled:cursor-not-allowed"
                >
