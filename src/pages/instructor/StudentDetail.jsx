    ...
    return (
      <div className="space-y-4">
        <Link
          ...
          className="inline-flex items-center gap-2 text-sm font-semibold text-[var(--yu-blue-700)] hover:underline"
        >
        ...
        <div className="rounded-xl border border-red-200 bg-[var(--yu-blue-700)]/10 p-4 text-sm text-red-700 dark:border-red-500/30 dark:bg-[var(--yu-blue-700)]/10 dark:text-red-300">
          ...
          <button
            ...
            className="ms-3 rounded bg-[var(--yu-blue-700)] px-2 py-1 text-xs font-bold text-white"
          >
              ...
              <div className="rounded-xl border border-slate-200 bg-white p-4 dark:border-white/8 dark:bg-[#1A1A22]">
                ...
                <div className="h-48" dir="ltr">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie data={pieData} dataKey="value" nameKey="name" outerRadius={70} fill="var(--yu-blue-700)">
                        {pieData.map((entry, i) => (
