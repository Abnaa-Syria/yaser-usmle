        ...
        render: (_, row) => (
          <div className="flex items-center gap-2">
            <div className="w-16 bg-slate-200 dark:bg-white/10 rounded-full h-1.5 overflow-hidden">
              <div 
                className="bg-[var(--yu-blue-700)] h-full rounded-full shadow-[0_0_4px_var(--yu-blue-700)]" 
      ...
      },
      {
        ...
        render: (_, row) => (
          <Link
            ...
            className="font-bold text-[var(--yu-blue-700)] hover:text-[var(--yu-blue-600)] hover:underline"
          >
    ...
    <section className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-[#1A1A22] flex flex-col justify-between h-28 transition-all hover:shadow-md">
          ...
          <div className="text-3xl font-extrabold text-[var(--yu-blue-700)] tracking-tight">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-[#1A1A22] flex flex-col justify-between h-28 transition-all hover:shadow-md">
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-slate-100 dark:bg-white/5 rounded-full h-1.5 overflow-hidden">
              <div 
                className="bg-gradient-to-r from-[var(--yu-blue-700)]/50 to-[var(--yu-blue-700)] h-full rounded-full shadow-[0_0_8px_var(--yu-blue-700)]" 
