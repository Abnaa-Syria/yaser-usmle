...
const formatCurrency = (val) => {
  ...
  return new Intl.NumberFormat("en-US").format(num) + " USD";
};
    ...
    <section className="space-y-8 min-h-screen text-slate-900 dark:text-slate-100">
      ...
      <div className="grid gap-6 sm:grid-cols-3">
        ...
        <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white/70 p-6 shadow-xl transition-all duration-300 hover:-translate-y-1 dark:border-slate-800 dark:bg-slate-900/60 dark:backdrop-blur-md dark:shadow-slate-950/40 hover:shadow-orange-500/5 dark:hover:shadow-orange-500/10">
          <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full bg-gradient-to-br from-[var(--yu-blue-700)]/15 to-transparent blur-xl transition-all duration-500 group-hover:scale-150" />
          <div className="flex items-start justify-between">
            <div className="space-y-1.5">
              <p className="text-[11px] font-bold uppercase tracking-widest text-slate-400 dark:text-slate-500">
                {t("dashboard.instructor.wallet.balance")}
              </p>
              <h3 className="text-3xl font-black text-[var(--yu-blue-700)] tracking-tight drop-shadow-[0_0_12px_rgba(238,124,17,0.1)]">
                {formatCurrency(summary?.balance ?? 0)}
              </h3>
            </div>
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-orange-500/10 text-[var(--yu-blue-700)] dark:bg-[var(--yu-blue-700)]/10">
          ...
          <button
            ...
            className="mt-6 w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[var(--yu-blue-700)] to-[var(--yu-blue-700)]/90 hover:from-[var(--yu-blue-600)] hover:to-[var(--yu-blue-700)] px-4 py-2.5 text-sm font-bold text-white shadow-lg shadow-orange-500/20 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98]"
          >
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white/50 p-6 shadow-xl dark:border-slate-850 dark:bg-slate-900/40 dark:backdrop-blur-md">
          <div className="mb-4 flex items-center justify-between">
            <h3 className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2">
              <span className="h-2 w-2 rounded-full bg-[var(--yu-blue-700)]" />
          ...
          <form onSubmit={onSubmit} className="w-full max-w-lg rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-800 dark:bg-slate-900 dark:text-white">
            <div className="mb-4 flex items-center justify-between border-b border-slate-100 pb-3 dark:border-slate-800">
              <h3 className="text-lg font-black text-slate-900 dark:text-white flex items-center gap-2">
                <DollarSign className="h-5 w-5 text-[var(--yu-blue-700)]" />
              ...
              <div className="grid grid-cols-2 gap-2 rounded-xl bg-slate-100 p-1 dark:bg-slate-950">
                <button
                  ...
                  className={`flex items-center justify-center gap-2 rounded-lg py-2.5 text-xs font-bold transition-all ${
                    selectedMethod === "BANK"
                      ? "bg-white text-[var(--yu-blue-700)] shadow-sm dark:bg-slate-850 dark:text-[var(--yu-blue-700)]"
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      className="h-10 w-full rounded-xl border border-slate-200 bg-white px-3 text-sm dark:border-white/10 dark:bg-slate-950 dark:text-white focus:border-[var(--yu-blue-700)] focus:ring-1 focus:ring-[var(--yu-blue-700)] outline-none transition-all"
                    />
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    type="number"
                    step="any"
                    className="h-10 w-full rounded-xl border border-slate-200 bg-white pe-12 ps-3 text-sm dark:border-white/10 dark:bg-slate-950 dark:text-white focus:border-[var(--yu-blue-700)] focus:ring-1 focus:ring-[var(--yu-blue-700)] outline-none transition-all"
                  />
                ...
                <p className="mt-1.5 text-[10px] text-slate-450 dark:text-slate-500 flex items-center gap-1">
                  ...
                  <span className="font-bold text-[var(--yu-blue-700)]">{formatCurrency(summary?.balance ?? 0)}</span>
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 flex justify-end gap-2.5 border-t border-slate-100 pt-4 dark:border-slate-800">
              ...
              <button 
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[var(--yu-blue-700)] to-[var(--yu-blue-700)]/90 hover:from-[var(--yu-blue-600)] hover:to-[var(--yu-blue-700)] px-5 py-2.5 text-sm font-bold text-white shadow-lg shadow-orange-500/25 disabled:opacity-50 transition-all duration-200 transform hover:scale-[1.02]"
              >
