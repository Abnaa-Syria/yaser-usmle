...
export function buildFallbackTopCourses(topCourses, totalStudents, isRtl) {
  ...
  const titles = isRtl
    ? ["القلب والأوعية", "الكلى", "المناعة", "الباثولوجي", "الفارماكولوجي"]
    : ["Cardiovascular", "Renal", "Immunology", "Pathology", "Pharmacology"];
  ...
  return [
    {
      ...
      label: isRtl ? "مراجعة القلب والأوعية" : "Cardiovascular Review",
    },
    {
      id: "fallback-pay-1",
      type: "payment",
      ...
      label: isRtl ? "الكلى والأحماض والقواعد" : "Renal & Acid–Base",
      amount: 249,
    },
    {
      ...
      label: isRtl ? "أساسيات المناعة" : "Immunology Foundations",
    },
  ];
}
